...
func test_single_game_completes_with_a_result():
	var r: Dictionary = MatchRunner.play_game(42, "wm01-001", "wm01-078", "aggro", "guard", 0)
...
func test_games_are_deterministic_for_a_seed():
	var a: Dictionary = MatchRunner.play_game(7, "wm01-001", "wm01-023", "aggro", "aggro", 0)
	var b: Dictionary = MatchRunner.play_game(7, "wm01-001", "wm01-023", "aggro", "aggro", 0)
...
func test_log_contains_setup_and_outcome():
	var r: Dictionary = MatchRunner.play_game(99, "wm01-045", "wm01-067", "aggro", "guard", 1)
	var kinds := {}
	for entry in r["log"]:
